...
import GenreSelection from "../User/GenreSelection";
...
function StarterProfile({ starter }) {
  ...
  const [isSelected, setSelectedStarter] = useState(false);
  ...
  return (
    <div>
      ...
      >
        ...
        >
          <div className="d-flex flex-column align-items-center justify-content-center">
            ...
            <button
              className="m-3 w-25"
              style={{ background: colorsFillButton }}
              onClick={() => {
                setSelectedStarter(true);
              }}
            >
              Choisir ce starter
            </button>
      ...
      {isSelected && <GenreSelection selected={starter.name}></GenreSelection>}
    </div>
  );
}
